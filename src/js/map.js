...
function init() {
	...
	city.forEach(function(item){
		goroda = goroda.add(ymaps.geocode(item,{results: 1,kind: 'locality'}));
	});
	...
	goroda.then(function(res){
		...
		$('ul.cities>li').click(function(){
			...
			// ��������� ������ � ������
			var c = $(this).html();
			var gc = ymaps.geocode(c,{results: 1,kind: 'locality'});
			...
			placeTr.each (function(j){
				...
				// ��������� ����� ��� ������� ������.
				var plMark = new ymaps.Placemark(gcc,{iconContent: j+1}/*
